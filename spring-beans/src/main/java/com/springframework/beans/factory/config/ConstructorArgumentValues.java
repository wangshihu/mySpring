...
public class ConstructorArgumentValues {
    ...
    /**
     * Deep copy constructor.深度拷贝的构造器
     ...
     * if demanded: see {@link com.springframework.beans.Mergeable}.
     ...
     * with the current value if demanded: see {@link com.springframework.beans.Mergeable}.
     * @param newValue the argument value in the form of a ValueHolder
     */
