 ...
 * 支持ManagedSet,ManagedList等集合类的合并
 *
 * @author Rob Harrop
 * @since 2.0
 * @see com.springframework.beans.factory.support.ManagedSet
 * @see com.springframework.beans.factory.support.ManagedList
 * @see com.springframework.beans.factory.support.ManagedMap
 * @see com.springframework.beans.factory.support.ManagedProperties
 */
